...
export const getProfileAluno = (req, res) => {
    ...
    const q = `
        ...
        SELECT
            ...
            r.nome AS responsavel_nome, r.cpf AS responsavel_cpf, r.telefone AS responsavel_telefone,

            r.email AS responsavel_email, r.grau_parentesco, r.renda_familiar, 
...
export const getAlunoTurmas = (req, res) => {
    ...
    db.query(q, [alunoId], (err, data) => {
        ...
        const formattedData = data.map(aula => ({
            ...
            professor: aula.professor || 'Não Atribuído', 

            horario: `${aula.horarioInicio.substring(0, 5)} - ${aula.horarioTermino.substring(0, 5)}`,
