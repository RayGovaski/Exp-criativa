...
export const AuthProvider = ({ children }) => {
  ...
  const fetchAndSetUserProfile = useCallback(async (jwtString) => { 
    ...
    switch (decodedUserPayload.role) { // Use o payload decodificado para a role
      case 'apoiador':
        profileEndpoint = `http://localhost:8000/apoiador/perfil`;
        break;
      case 'aluno':
        profileEndpoint = `http://localhost:8000/aluno/perfil`;
        break;
      case 'professor':
        profileEndpoint = `http://localhost:8000/professores/perfil`;
        break;
      case 'administrador':
        profileEndpoint = `http://localhost:8000/administrador/perfil`;
