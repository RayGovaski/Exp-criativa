...
const CriarCardDoacao = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.imagem) {
      submitData.append('imagem', formData.imagem); // 'imagem_doacao' deve ser o nome do campo esperado pelo Multer
    }
        ...
        <Form.Group className="mb-3" controlId="formImagemDoacao">
          ...
          <div className="file-input-wrapper">
            <div className="file-input-container">
              <Form.Control
                type="file"
                name="imagem" // Este nome deve corresponder ao que o Multer espera
